...
describe('settings-profile', () => {
    ...
    it('test values of inputs', () => {
        cy.get('#settings-profile-userName').should(
            'have.value',
            userData.userName
        );
        cy.get('#settings-profile-firstName').should(
            'have.value',
            userData.firstName
        );
        cy.get('#settings-profile-lastName').should(
            'have.value',
            userData.lastName
        );
        cy.get('#settings-profile-city').should('have.value', userData.city);
        cy.get('#settings-profile-aboutMe').should(
            'have.value',
            userData.aboutMe
        );
    });
