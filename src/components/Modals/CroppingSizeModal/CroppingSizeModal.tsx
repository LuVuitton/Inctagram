        ...
        <div className={s.cropping__size}>
            <div className={s.cropping__items}>
                <div
                    ...
                    onClick={() => {
                        dispatch(
                            postActions.setCropAspectRatio(AspectRatioType.one)
                        );
                    }}
                >
                    <p
                ...
                <div
                    ...
                    onClick={() =>
                        dispatch(
                            postActions.setCropAspectRatio(AspectRatioType.two)
                        )
                    }
                >
                    <p
                ...
                <div
                    ...
                    onClick={() =>
                        dispatch(
                            postActions.setCropAspectRatio(
                                AspectRatioType.three
                            )
                        )
                    }
                >
                ...
                <div
                    ...
                    onClick={() =>
                        dispatch(
                            postActions.setCropAspectRatio(AspectRatioType.four)
                        )
                    }
                >
                    <p
